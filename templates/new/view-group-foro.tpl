<div class="portlet box "  style="background-colo:white;  border-radius: 2px;   border: 1px solid #73AD21 ">
    <div class="portlet-title" style="background-colo:white; color: #73b760; ">
        ...
        <div class="actions">
            ...
            {else}
                <a href="{$WEB_ROOT}/graybox.php?page=add-group-topic&id={$myModule["courseId"]}&modulo={$module}" data-target="#ajax" data-toggle="modal" class="btn btn-default btn-sm" style="background:#73AD21; color:white">
