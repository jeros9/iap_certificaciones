<form class="form-horizontal" id="addMajorForm" name="addMajorForm" method="post" enctype="multipart/form-data" action="{$WEB_ROOT}/upload-group-homework/id/{$actividad.activityId}">
    <input type="hidden" name="modality" id="modality" value="{$actividad.modality}"/>
    <input type="hidden" name="courseId" id="courseId" value="{$actividad.courseId}"/>
    <input type="hidden" id="type" name="type" value="saveAddMajor"/>
	<div style="text-align:justify">
        <p>Únicamente se puede subir un solo archivo por actividad, por lo que si necesita subir varios archivos le recomendamos los comprima en .rar y los suba por este medio.</p>
        <p>Solamente tendrá la opción de volver a subir su actividad en una ocasión.</p>
	</div>
    <div class="form-body">
