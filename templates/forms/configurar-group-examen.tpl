<form id="addMajorForm" name="addMajorForm" method="post">
	...
	<center><input type="submit" id="addMajor" name="addMajor" value="Guardar" class="btn green"  /></center><br><br>
	...
	<div class="content-settings-row-register" align="center">
		<div id="tblContent2">{include file="lists/group-questions.tpl"}</div>
	</div>      
	</div> 
</form>