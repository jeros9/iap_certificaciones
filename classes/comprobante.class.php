...
//		print_r($cadenaOriginalTimbre);
	...
	function CancelarComprobante($data = null, $id_comprobante = 0, $notaCredito = false, $recipient = null)
	{
...
class PDF_ImageAlpha extends PDF{ 
	...
	*                                                                              * 
	*******************************************************************************/ 
	function Image($file = null, $x = 0, $y = 0, $w = 0, $h = 0, $type = '', $link = '', $isMask = false, $maskImg = 0) 
	{ 
